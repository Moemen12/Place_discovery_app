...
const Footer = () => {
  ...
  return (
    <section>
      <footer
        className="sm:footer hidden p-10 text-base-content"
        style={{
          backgroundColor: color !== "night" ? "rgb(228, 234, 252)" : "",
        }}
      >
        <nav>
      ...
      <footer
        className="sm:footer hidden px-10 py-4 border-t bg-base-200 text-base-content border-base-300"
        style={{
          backgroundColor: color !== "night" ? "rgb(228, 234, 252)" : "",
        }}
      >
