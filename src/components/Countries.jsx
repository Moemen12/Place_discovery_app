...
const CustomDropdown = ({ countries }) => {
  ...
  return (
    <div
      className="relative rounded-md border-slate-600 border inline-block text-left w-full sm:max-w-[30rem]"
      ref={dropdownRef}
    >
      <div>
        <button
          type="button"
          className="inline-flex justify-center w-full rounded-md px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-800 transition duration-150 ease-in-out"
          id="options-menu"
          aria-haspopup="true"
          aria-expanded="true"
        ...
        <div className="origin-top-left absolute left-0 mt-2 w-full rounded-md shadow-lg overflow-y-auto max-h-40">
          <div className="rounded-md bg-white shadow-xs">
            <ul>
              ...
              >
                I prefer not to select a country
              </li>
              {loading
